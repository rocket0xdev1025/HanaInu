import { f as j, h as C } from "./index-CcZysQD2.js";
var p = { exports: {} },
...
o.prototype.emit = function (e) {
  ...
  if (typeof c == "function") h(c, this, n);
  else for (var d = c.length, O = E(c, d), r = 0; r < d; ++r) h(O[r], this, n);
  return !0;
};
function g(t, e, n, r) {
  var i, f, s;
...
function P(t, e) {
  return new Promise(function (n, r) {
    ...
    x(t, e, f, { once: !0 }), e !== "error" && T(t, i, { once: !0 });
  });
}
function T(t, e, n) {
  typeof t.on == "function" && x(t, "error", e, n);
}
function x(t, e, n, r) {
